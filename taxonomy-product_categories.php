...
<main id="primary" class="site-main">
    <?php if (get_field('hero_style', $term) == 'small') { ?>
        <?php echo do_blocks('<!-- wp:mcalpine/small-hero {"name":"mcalpine/small-hero","data":{"title":"' . get_the_title($term) . '","_title":"field_64ef3eb65a74d","message":"' . get_field('hero_message', $term) . '","_message":"field_64ef3ec25a74e","image":"' . get_field('category_hero_image', $term) . '","_image":"field_64ef3ed55a74f","breadcrumb_middle_link":{"title":"Products","url":"http://mcalpine2.local/products/","target":""},"_breadcrumb_middle_link":"field_64ef4f89decd4","end_breadcrumb_text":"asdasd","_end_breadcrumb_text":"field_6554ef111503e"},"mode":"edit"} /-->'); ?>
    <?php } ?>
    <?php if (get_field('hero_style', $term) == 'large') { ?>
        <?php echo do_blocks('<!-- wp:mcalpine/small-hero {"name":"mcalpine/small-hero","data":{"title":"' . get_the_title($term) . '","_title":"field_64ef3eb65a74d","message":"' . get_field('hero_message', $term) . '","_message":"field_64ef3ec25a74e","image":"' . get_field('category_hero_image', $term) . '","_image":"field_64ef3ed55a74f","breadcrumb_middle_link":{"title":"Products","url":"http://mcalpine2.local/products/","target":""},"_breadcrumb_middle_link":"field_64ef4f89decd4"},"mode":"edit"} /-->'); ?>
    <?php } ?>
    <?php if (have_posts()) : ?>
