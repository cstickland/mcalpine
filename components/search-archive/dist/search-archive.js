...
(function (global, factory) {
    ...
    // (17:8) {#if insight.item.postType == 'page'}
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h6, file$5, 17, 12, 565);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(17:8) {#if insight.item.postType == 'page'}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	let div5_outro;
    	let current;
    	let if_block = /*insight*/ ctx[0].item.postType == 'page' && create_if_block$4(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$5, 19, 8, 628);
    			attr_dev(div0, "class", "insight-card-text");
    			add_location(div0, file$5, 15, 4, 475);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*insight*/ 1) && raw_value !== (raw_value = /*insight*/ ctx[0].item.node.title + "")) h3.innerHTML = raw_value;
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$2.warn(`<InsightCard> was created with unknown prop '${key}'`);
    	});
    ...
    // (21:20) {#if product.item.customFields2.skus.length == 1}
    function create_if_block_1$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(21:20) {#if product.item.customFields2.skus.length == 1}",
    		ctx
    	});
    ...
    // (22:32) {#if product.item.customFields2.skus.length > 1}
    function create_if_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(22:32) {#if product.item.customFields2.skus.length > 1}",
    		ctx
    	});
    ...
    // (41:16) {#each product.item.customFields2.skus as sku}
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$4, 42, 24, 1708);
    			add_location(span, file$4, 41, 20, 1677);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:16) {#each product.item.customFields2.skus as sku}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*product*/ ctx[0].item.customFields2.skus.length == 1 && create_if_block_1$3(ctx);
    	let if_block1 = /*product*/ ctx[0].item.customFields2.skus.length > 1 && create_if_block$3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a3, file$4, 83, 4, 3375);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.on_mount.push(function () {
    		if (totalPages === undefined && !('totalPages' in $$props || $$self.$$.bound[$$self.$$.props['totalPages']])) {
    			console_1$1.warn("<Pagination> was created without expected prop 'totalPages'");
    		}
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 7, 8, 166);
    			add_location(h1, file$1, 8, 8, 233);
    			attr_dev(span, "class", "search-hero__highlight");
    			add_location(span, file$1, 11, 16, 345);
    			add_location(p0, file$1, 10, 12, 306);
    			add_location(p1, file$1, 15, 12, 482);
    			attr_dev(div1, "class", "search-hero-text");
    			add_location(div1, file$1, 9, 8, 263);
    			attr_dev(div2, "class", "search-hero-content");
    			add_location(div2, file$1, 6, 4, 124);
    			attr_dev(div3, "class", "search-hero-image-container");
    			add_location(div3, file$1, 18, 4, 558);
    			attr_dev(div4, "class", "search-hero-block animate");
    			add_location(div4, file$1, 5, 0, 80);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*totalResults*/ 2) set_data_dev(t5, /*totalResults*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    // (125:12) {#if transition == false && insightsDividedIntoPages && insightsDividedIntoPages.length}
    function create_if_block_1(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value = /*insightsDividedIntoPages*/ ctx[5][/*$currentPage*/ ctx[1] - 1];
    	validate_each_argument(each_value);
    	let each_blocks = [];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*insightsDividedIntoPages, $currentPage*/ 34) {
    				each_value = /*insightsDividedIntoPages*/ ctx[5][/*$currentPage*/ ctx[1] - 1];
    				validate_each_argument(each_value);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(125:12) {#if transition == false && insightsDividedIntoPages && insightsDividedIntoPages.length}",
    		ctx
    	});
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*insightsDividedIntoPages, $currentPage*/ 34) productcard_changes.product = /*insight*/ ctx[12];
    ...
    // (127:20) {#if insight.postType === "other"}
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(127:20) {#if insight.postType === \\\"other\\\"}",
    		ctx
    	});
    ...
    // (126:16) {#each insightsDividedIntoPages[$currentPage - 1] as insight}
    function create_each_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*insight*/ ctx[12].postType === "other") return 0;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(126:16) {#each insightsDividedIntoPages[$currentPage - 1] as insight}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	hero = new Hero({
    			props: {
    				...
    				totalResults: /*totalResults*/ ctx[3]
    			},
    			$$inline: true
    		});
    	...
    	let if_block0 = /*transition*/ ctx[2] == false && /*insightsDividedIntoPages*/ ctx[5] && /*insightsDividedIntoPages*/ ctx[5].length && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 118, 0, 3328);
    			attr_dev(ul, "class", "insight-archive-grid");
    			add_location(ul, file, 123, 8, 3503);
    			attr_dev(div1, "class", "insight-archive-grid-container");
    			add_location(div1, file, 122, 4, 3450);
    			attr_dev(div2, "class", "pagination-container");
    			add_location(div2, file, 135, 4, 4046);
    			attr_dev(section, "class", "insight-archive");
    			add_location(section, file, 121, 0, 3412);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*totalResults*/ 8) hero_changes.totalResults = /*totalResults*/ ctx[3];
    			hero.$set(hero_changes);

    			if (/*transition*/ ctx[2] == false && /*insightsDividedIntoPages*/ ctx[5] && /*insightsDividedIntoPages*/ ctx[5].length) {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);

    					if (dirty & /*transition, insightsDividedIntoPages*/ 36) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, currentPage, $$value => $$invalidate(1, $currentPage = $$value));
    	validate_store(filters, 'filters');
    	component_subscribe($$self, filters, $$value => $$invalidate(8, $filters = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	onMount(async () => {
    		...
    		$$invalidate(3, totalResults = $allItems.length);
    	});

    	let totalPages = 0;

    	allItems.subscribe(value => {
    		$$invalidate(5, insightsDividedIntoPages = divideItemsIntoPages(postsPerPage, value, $currentPage, $filters));
    		console.log(insightsDividedIntoPages);
    		$$invalidate(4, totalPages = insightsDividedIntoPages.length);
    	});

    	filters.subscribe(value => {
    		$$invalidate(5, insightsDividedIntoPages = divideItemsIntoPages(postsPerPage, $allItems, $currentPage, value));
    		$$invalidate(4, totalPages = insightsDividedIntoPages.length);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('totalResults' in $$props) $$invalidate(3, totalResults = $$props.totalResults);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$allItems, $currentPage, $filters*/ 386) {
    			$$invalidate(5, insightsDividedIntoPages = divideItemsIntoPages(postsPerPage, $allItems, $currentPage, $filters));
    		}
    	};
