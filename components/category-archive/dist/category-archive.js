...
(function (global, factory) {
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 29, 4, 660);
    		},
    		m: function mount(target, anchor) {
    ...
    // (34:4) {#if currentPage == totalPages && totalPages > 2}
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 34, 8, 819);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(34:4) {#if currentPage == totalPages && totalPages > 2}",
    		ctx
    	});
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "pagination-button");
    			add_location(button, file$1, 42, 8, 1046);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    // (55:4) {#if currentPage < totalPages}
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "pagination-button");
    			add_location(button, file$1, 55, 8, 1386);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(55:4) {#if currentPage < totalPages}",
    		ctx
    	});
    ...
    // (63:4) {#if currentPage == 1 && totalPages > 2}
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "pagination-button");
    			add_location(button, file$1, 63, 8, 1632);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(63:4) {#if currentPage == 1 && totalPages > 2}",
    		ctx
    	});
    ...
    // (71:4) {#if currentPage < totalPages - 1 && totalPages > 3}
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 71, 47, 1929);
    			attr_dev(div, "class", "pagination-seperator-dots");
    			add_location(div, file$1, 71, 8, 1890);
    			attr_dev(button, "class", "pagination-button");
    			add_location(button, file$1, 72, 8, 1960);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(71:4) {#if currentPage < totalPages - 1 && totalPages > 3}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "prev-next-button");
    			button.disabled = true;
    			add_location(button, file$1, 91, 4, 2361);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
    ...
    // (82:0) {#if currentPage < totalPages}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Next";
    			attr_dev(button, "class", "prev-next-button");
    			add_location(button, file$1, 82, 4, 2186);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(82:0) {#if currentPage < totalPages}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 50, 4, 1244);
    			attr_dev(div, "class", "page-number-buttons");
    			add_location(div, file$1, 32, 0, 723);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
  ...
  warranties {
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(78:12) {#if transition == false}",
    		ctx
    	});
    ...
    // (79:12) {#each currentPageItems as item}
    function create_each_block(ctx) {
    	let card;
    	let current;
    	const card_spread_levels = [/*item*/ ctx[10]];
    	let card_props = {};
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(card_spread_levels, [get_spread_object(/*item*/ ctx[10])])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(79:12) {#each currentPageItems as item}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	function pagination_transition_binding(value) {
    		/*pagination_transition_binding*/ ctx[8](value);
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file, 76, 8, 2233);
    			attr_dev(div0, "class", "insight-archive-grid-container");
    			add_location(div0, file, 75, 4, 2180);
    			attr_dev(div1, "class", "pagination-container");
    			add_location(div1, file, 84, 4, 2470);
    			attr_dev(section, "class", "insight-archive");
    			add_location(section, file, 74, 0, 2142);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	allItems.subscribe(value => {
    		$$invalidate(6, itemsDividedIntoPages = divideItemsIntoPages(postsPerPage, value));
    	});
    	...
    	$$self.$$set = $$props => {
    		if ('archiveType' in $$props) $$invalidate(4, archiveType = $$props.archiveType);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('postsPerPage' in $$props) $$invalidate(5, postsPerPage = $$props.postsPerPage);
    		if ('currentPage' in $$props) $$invalidate(0, currentPage = $$props.currentPage);
    		if ('itemsDividedIntoPages' in $$props) $$invalidate(6, itemsDividedIntoPages = $$props.itemsDividedIntoPages);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*itemsDividedIntoPages, currentPage*/ 65) {
    			$$invalidate(2, currentPageItems = itemsDividedIntoPages[currentPage - 1] || []);
    		}
    	};
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { archiveType: 4, postsPerPage: 5 });
