...
(function (global, factory) {
  ...
  posts(where: {categoryName: "faq"}) {
    ...
    /* src/Accordion.svelte generated by Svelte v3.59.1 */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 24, 8, 613);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 9, 4, 207);
    			attr_dev(h5, "class", "accordion-question");
    			add_location(h5, file$1, 17, 8, 387);
    			attr_dev(div1, "class", "vertical-line");
    			add_location(div1, file$1, 19, 12, 490);
    			attr_dev(div2, "class", "horizontal-line");
    			add_location(div2, file$1, 20, 12, 532);
    			attr_dev(div3, "class", "accordion-toggle-icon");
    			add_location(div3, file$1, 18, 8, 442);
    			attr_dev(div4, "class", "accordion-question-container");
    			add_location(div4, file$1, 10, 4, 241);
    			attr_dev(div5, "class", div5_class_value = "accordion " + (/*open*/ ctx[2] ? 'open' : ''));
    			add_location(div5, file$1, 8, 0, 158);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div4, "click", /*click_handler*/ ctx[4], false, false, false, false),
    					listen_dev(div4, "keydown", /*keydown_handler*/ ctx[3], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*open*/ 4 && div5_class_value !== (div5_class_value = "accordion " + (/*open*/ ctx[2] ? 'open' : ''))) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ slide, open, question, answer });
    	...
    	return [question, answer, open, keydown_handler, click_handler];
    }

    class Accordion extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { question: 0, answer: 1 });
    ...
    function create_each_block(ctx) {
    	...
    	let div_transition;
    	let current;
    	let if_block = /*questions*/ ctx[0].length > 0 && create_if_block(ctx);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		$$invalidate(0, questions = results.data.posts.edges);
