  ...
  posts(where: {categoryName: "faq"}) {
    ...
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(37:12) {#if questions.length > 0}",
    		ctx
    	});
    ...
    // (38:16) {#each [...categories] as category}
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file, 38, 20, 1110);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(38:16) {#each [...categories] as category}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(48:16) {#if questions.length > 0}",
    		ctx
    	});
    ...
    // (50:24) {#if question.node.categories.edges[0].node.name == category}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*questions*/ 1) accordion_changes.id = /*question*/ ctx[7].node.postId;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(50:24) {#if question.node.categories.edges[0].node.name == category}",
    		ctx
    	});
    ...
    // (49:20) {#each questions as question}
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(49:20) {#each questions as question}",
    		ctx
    	});
    ...
    // (45:8) {#each [...categories] as category}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file, 46, 16, 1364);
    			attr_dev(div, "id", /*category*/ ctx[4]);
    			add_location(div, file, 45, 12, 1312);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h3);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(45:8) {#each [...categories] as category}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 28, 8, 774);
    			add_location(h5, file, 35, 12, 983);
    			attr_dev(div0, "class", "category-links");
    			add_location(div0, file, 34, 8, 942);
    			attr_dev(div1, "class", "categories-container");
    			add_location(div1, file, 27, 4, 731);
    			attr_dev(div2, "class", "questions-container");
    			add_location(div2, file, 43, 4, 1222);
    			attr_dev(section, "class", "faq-archive");
    			add_location(section, file, 26, 0, 697);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
