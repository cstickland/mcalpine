...
(function (global, factory) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h6, file$2, 9, 8, 273);
    			attr_dev(h3, "class", "insight-card-title");
    			add_location(h3, file$2, 10, 8, 338);
    			attr_dev(div0, "class", "insight-card-text");
    			add_location(div0, file$2, 8, 4, 233);
    			...
    			add_location(img, file$2, 13, 8, 456);
    			attr_dev(div1, "class", "insight-card-hover-gradient");
    			add_location(div1, file$2, 18, 8, 609);
    			attr_dev(div2, "class", "insight-card-image-container");
    			add_location(div2, file$2, 12, 4, 405);
    			add_location(span, file$2, 23, 13, 779);

    			attr_dev(a, "href", a_href_value = /*insight*/ ctx[0].permalink
    			? /*insight*/ ctx[0].permalink
    			: "");

    			add_location(a, file$2, 22, 8, 713);
    			attr_dev(div3, "class", "insight-card-link");
    			add_location(div3, file$2, 21, 4, 673);
    			attr_dev(div4, "class", div4_class_value = "insight-card " + /*openClass*/ ctx[1]);
    			add_location(div4, file$2, 7, 0, 162);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*openClass*/ 2 && div4_class_value !== (div4_class_value = "insight-card " + /*openClass*/ ctx[1])) {
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 17, 4, 339);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Prev";
    			attr_dev(button, "class", "prev-next-button");
    			add_location(button, file$1, 11, 4, 186);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 22, 8, 498);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "pagination-button");
    			add_location(button, file$1, 29, 8, 712);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "pagination-button");
    			add_location(button, file$1, 39, 8, 1029);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "pagination-button");
    			add_location(button, file$1, 45, 8, 1247);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 53, 47, 1532);
    			attr_dev(div, "class", "pagination-seperator-dots");
    			add_location(div, file$1, 53, 8, 1493);
    			attr_dev(button, "class", "pagination-button");
    			add_location(button, file$1, 54, 8, 1563);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "prev-next-button");
    			button.disabled = true;
    			add_location(button, file$1, 73, 4, 1945);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Next";
    			attr_dev(button, "class", "prev-next-button");
    			add_location(button, file$1, 65, 4, 1778);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 36, 4, 897);
    			attr_dev(div, "class", "page-number-buttons");
    			add_location(div, file$1, 20, 0, 402);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (42:12) {#if i >= postRangeLow && i < postRangeHigh}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(42:12) {#if i >= postRangeLow && i < postRangeHigh}",
    		ctx
    	});
    ...
    // (41:8) {#each allProductsList as insight, i}
    function create_each_block(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*i*/ ctx[13] >= /*postRangeLow*/ ctx[3] && /*i*/ ctx[13] < /*postRangeHigh*/ ctx[1] && create_if_block_1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*i*/ ctx[13] >= /*postRangeLow*/ ctx[3] && /*i*/ ctx[13] < /*postRangeHigh*/ ctx[1]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*postRangeLow, postRangeHigh*/ 10) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:8) {#each allProductsList as insight, i}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	function pagination_currentPage_binding(value) {
    		/*pagination_currentPage_binding*/ ctx[9](value);
    	}
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	let each_value = /*allProductsList*/ ctx[5];
    	...
    	let if_block = /*totalPages*/ ctx[4] > 1 && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", /*gridStyle*/ ctx[6]
    			? 'product-archive-grid columns'
    			: 'product-archive-grid rows');

    			add_location(ul, file, 39, 4, 887);
    			attr_dev(div0, "class", "product-archive-grid-container");
    			add_location(div0, file, 38, 4, 838);
    			attr_dev(div1, "class", "pagination-container");
    			add_location(div1, file, 47, 4, 1177);
    			attr_dev(section, "class", section_class_value = "product-archive " + /*filtersClass*/ ctx[2]);
    			add_location(section, file, 36, 0, 784);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*allProductsList, postRangeLow, postRangeHigh*/ 42) {
    				each_value = /*allProductsList*/ ctx[5];
    				validate_each_argument(each_value);
    				let i;
    			...
    			if (!current || dirty & /*filtersClass*/ 4 && section_class_value !== (section_class_value = "product-archive " + /*filtersClass*/ ctx[2])) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ('allInsights' in $$props) $$invalidate(7, allInsights = $$props.allInsights);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('allProductsList' in $$props) $$invalidate(5, allProductsList = $$props.allProductsList);
    		if ('gridStyle' in $$props) $$invalidate(6, gridStyle = $$props.gridStyle);
    		if ('filtersClass' in $$props) $$invalidate(2, filtersClass = $$props.filtersClass);
    		if ('postRangeHigh' in $$props) $$invalidate(1, postRangeHigh = $$props.postRangeHigh);
    		if ('postRangeLow' in $$props) $$invalidate(3, postRangeLow = $$props.postRangeLow);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*allInsights*/ 128) {
    			$$invalidate(8, totalProducts = getTotal(allInsights));
    		}

    		if ($$self.$$.dirty & /*totalProducts*/ 256) {
    			$$invalidate(4, totalPages = Math.ceil(totalProducts / postsPerPage));
    		}

    		if ($$self.$$.dirty & /*currentPage*/ 1) {
    			$$invalidate(1, postRangeHigh = currentPage * postsPerPage);
    		}

    		if ($$self.$$.dirty & /*postRangeHigh*/ 2) {
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { allInsights: 7 });
