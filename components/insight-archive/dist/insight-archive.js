...
(function (global, factory) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 20, 8, 687);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	let div5_outro;
    	let current;
    	let if_block = /*insight*/ ctx[0].img && create_if_block$3(ctx);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*currentPageInsights*/ 2) insightcard_changes.insight = /*insight*/ ctx[12];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('allInsights' in $$props) $$invalidate(4, allInsights = $$props.allInsights);
    		if ('archiveGrid' in $$props) archiveGrid = $$props.archiveGrid;
    		if ('currentPage' in $$props) $$invalidate(0, currentPage = $$props.currentPage);
