...
(function (global, factory) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div3, file$2, 23, 39, 805);
    			...
    			add_location(div4, file$2, 21, 4, 673);
    			attr_dev(div5, "class", div5_class_value = "insight-card " + /*openClass*/ ctx[1]);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*openClass*/ 2 && div5_class_value !== (div5_class_value = "insight-card " + /*openClass*/ ctx[1])) {
    ...
    // (37:12) {#if i >= postRangeLow && i < postRangeHigh}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(37:12) {#if i >= postRangeLow && i < postRangeHigh}",
    		ctx
    	});
    ...
    // (36:8) {#each allInsights as insight, i}
    function create_each_block(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*i*/ ctx[12] >= /*postRangeLow*/ ctx[3] && /*i*/ ctx[12] < /*postRangeHigh*/ ctx[2] && create_if_block_1(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*i*/ ctx[12] >= /*postRangeLow*/ ctx[3] && /*i*/ ctx[12] < /*postRangeHigh*/ ctx[2]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*postRangeLow, postRangeHigh*/ 12) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(36:8) {#each allInsights as insight, i}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(ul, "class", /*gridStyle*/ ctx[5]
    			? 'product-archive-grid columns'
    			: 'product-archive-grid rows');

    			add_location(ul, file, 34, 4, 791);
    			attr_dev(div0, "class", "product-archive-grid-container");
    			add_location(div0, file, 33, 4, 742);
    			attr_dev(div1, "class", "pagination-container");
    			add_location(div1, file, 42, 4, 1077);
    			attr_dev(section, "class", "product-archive " + /*filtersClass*/ ctx[6]);
    			add_location(section, file, 31, 0, 688);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*allInsights, postRangeLow, postRangeHigh*/ 13) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('gridStyle' in $$props) $$invalidate(5, gridStyle = $$props.gridStyle);
    		if ('filtersClass' in $$props) $$invalidate(6, filtersClass = $$props.filtersClass);
    		...
    		if ('totalProducts' in $$props) $$invalidate(7, totalProducts = $$props.totalProducts);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*allInsights*/ 1) {
    			$$invalidate(7, totalProducts = getTotal(allInsights));
    		}

    		if ($$self.$$.dirty & /*totalProducts*/ 128) {
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { allInsights: 0 });
