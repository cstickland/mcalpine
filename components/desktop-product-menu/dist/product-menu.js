...
(function (global, factory) {
  ...
  productCategories(first: 1000) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "Product";
    			t1 = space();
    			create_component(content.$$.fragment);
    			attr_dev(div0, "class", "product-text svelte-1tgj1oi");
    			add_location(div0, file, 23, 85, 577);
    			add_location(div1, file, 23, 0, 492);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { siteUrl: 2, allProductsLink: 0 });
