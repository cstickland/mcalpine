...
(function (global, factory) {
    ...
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$7, 42, 24, 1561);
    			add_location(span, file$7, 41, 20, 1530);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	let if_block = /*innerWidth*/ ctx[1] < 650 && create_if_block$3(ctx);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	return [gridStyle, innerWidth, onwindowresize, click_handler];
    }
